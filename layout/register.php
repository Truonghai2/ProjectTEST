<div class="resgiter-layout d-flex flex-direction-column justify-content-center align-items-center" style="
            ...
            <div class="title-error">
                ...
                <?php 
                    if(isset($_SESSION['error'])){
                        ...
                        unset($_SESSION['error']); // Xóa thông báo lỗi để không hiển thị lần tiếp theo
                    }
                ?>
            </div>
